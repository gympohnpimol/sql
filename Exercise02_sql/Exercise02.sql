...
-- 2.16
-- Add a new department called "Quality Assurance", 
...
INSERT INTO Department2(Code, Name, Budget) VALUES (11, 'Quality Assurance', 40000)
INSERT INTO Employee2(SSN, Name, LastName, Department) VALUES (847219811, 'Mary', 'Moore', 11)
...
-- 2.18
-- Reassign all employees from the Research department (code 77) 
-- to the IT department (code 14).
UPDATE Employee2
    SET Department = 14
    WHERE Department = 77
...
-- who work in departments with a budget greater than or equal to $60,000.
DELETE FROM Employee2
WHERE Department IN (
    SELECT Code
    FROM Department2
